# -*- coding: utf-8 -*-
#
# keybase documentation build configuration file, created by
...
latex_documents = [
  ('index', 'keybase.tex', u'keybase Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    ('index', 'keybase', u'keybase Documentation',
     [u'Author'], 1)
]
...
texinfo_documents = [
  ('index', 'keybase', u'keybase Documentation',
   u'Author', 'keybase', 'One line description of project.',
   'Miscellaneous'),
]
